 ...
 * @author nitelow
 */
@Database(entities = {User.class, Hospital.class, HospitalDevice.class, Report.class, OrganizationalUnit.class, ImageUploadJob.class, Observable.class}, version = 9)
